...
### WebSockets vs. HTTP <a href="#websockets-vs-http" id="websockets-vs-http"></a>
...
_Note: if you have an Alchemy account you can replace `demo` with your own API key._ [_Sign up for a free Alchemy account here!_](https://auth.alchemyapi.io/signup)
...
### How to use WebSockets <a href="#how-to-use-websockets" id="how-to-use-websockets"></a>
...
![Where to find your WebSocket URL in your Alchemy dashboard](../../../public/content/developers/tutorials/using-websockets/use-websockets.gif)
...
### With Web3 <a href="#with-web3" id="with-web3"></a>
...
### Subscription API <a href="#subscription-api" id="subscription-api"></a>
