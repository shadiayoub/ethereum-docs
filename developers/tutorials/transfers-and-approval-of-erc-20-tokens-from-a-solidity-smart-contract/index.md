...
description: >-
  How to use a smart contract to interact with a token using the Solidity
  language
---

# Transfers and approval of ERC-20 tokens from a solidity smart contract

In the previous tutorial we studied [the anatomy of an ERC-20 token in Solidity](../understand-the-erc-20-token-smart-contract/) on the Ethereum blockchain. In this article we’ll see how we can use a smart contract to interact with a token using the Solidity language.

For this smart contract, we’ll create a really dummy decentralized exchange where a user can trade ether for our newly deployed [ERC-20 token](../../docs/standards/tokens/erc-20/).
...
![Two events in the transaction: Transfer and Bought](../../../public/content/developers/tutorials/transfers-and-approval-of-erc-20-tokens-from-a-solidity-smart-contract/transfer-and-bought-events.png)
...
![Two events in the transaction: Transfer and Sold](../../../public/content/developers/tutorials/transfers-and-approval-of-erc-20-tokens-from-a-solidity-smart-contract/transfer-and-sold-events.png)
