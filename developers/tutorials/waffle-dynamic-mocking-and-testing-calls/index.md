...
### What is this tutorial about? <a href="#what-is-this-tutorial-about" id="what-is-this-tutorial-about"></a>
...
### Dynamic mocking <a href="#dynamic-mocking" id="dynamic-mocking"></a>
...
#### **1. Project** <a href="#id-1-project" id="id-1-project"></a>
...
#### **2. Smart contract** <a href="#id-2-smart-contract" id="id-2-smart-contract"></a>
...
#### **3. Testing** <a href="#id-3-testing" id="id-3-testing"></a>
...
![One test passing](../../../public/content/developers/tutorials/waffle-dynamic-mocking-and-testing-calls/test-one.png)
...
![Two tests passing](../../../public/content/developers/tutorials/waffle-dynamic-mocking-and-testing-calls/test-two.png)

...and here you are! Our contract seems to work as intended :)

### Testing contract calls <a href="#testing-contract-calls" id="testing-contract-calls"></a>
...
![Three tests passing](../../../public/content/developers/tutorials/waffle-dynamic-mocking-and-testing-calls/test-three.png)
...
### The Finish Line <a href="#the-finish-line" id="the-finish-line"></a>
...
* [Testing smart contracts with Waffle](../waffle-test-simple-smart-contract/)
