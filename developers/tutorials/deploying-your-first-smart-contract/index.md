...
description: >-
  An introduction to deploying your first smart contract on an Ethereum test
  network
---

# Deploying your first smart contract

I guess you are as excited as us to [deploy](../../docs/smart-contracts/deploying/) and interact with your first [smart contract](../../docs/smart-contracts/) on the Ethereum blockchain.

Don’t worry, as it’s our first smart contract, we’ll deploy it on a [local test network](../../docs/networks/) so it does not cost anything for you to deploy and play as much as you’d like with it.

### Writing our contract <a href="#writing-our-contract" id="writing-our-contract"></a>
...
![Adding a new file in the Remix interface](../../../public/content/developers/tutorials/deploying-your-first-smart-contract/remix.png)
...
### Deploying our contract <a href="#deploying-our-contract" id="deploying-our-contract"></a>

As we wrote our very first smart contract, we’ll now deploy it to the blockchain to be able to play with it.

[Deploying the smart contract on the blockchain](../../docs/smart-contracts/deploying/) is actually just sending a transaction containing the code of the compiled smart contract without specifying any recipients.

We’ll first [compile the contract](../../docs/smart-contracts/compiling/) by clicking on the compile icon on the left hand side:

![The compile icon in the Remix toolbar](../../../public/content/developers/tutorials/deploying-your-first-smart-contract/remix-compile-button.png)

Then click on the compile button:

![The compile button in the Remix solidity compiler](../../../public/content/developers/tutorials/deploying-your-first-smart-contract/remix-compile.png)
...
![The deploy icon in the Remix toolbar](../../../public/content/developers/tutorials/deploying-your-first-smart-contract/remix-deploy.png)
...
![The deploy button in the Remix solidity compiler](../../../public/content/developers/tutorials/deploying-your-first-smart-contract/remix-deploy-button.png)
...
![The function button in the Remix solidity compiler](../../../public/content/developers/tutorials/deploying-your-first-smart-contract/remix-function-button.png)
...
![A log of transactions](../../../public/content/developers/tutorials/deploying-your-first-smart-contract/transaction-log.png)
...
![Newly updated state of the smart contract](../../../public/content/developers/tutorials/deploying-your-first-smart-contract/updated-state.png)

In the next tutorial, we’ll cover [how you can add events to your smart contracts](../logging-events-smart-contracts/). Logging events is a convenient way to debug your smart contract and understand what is happening while calling a function.
