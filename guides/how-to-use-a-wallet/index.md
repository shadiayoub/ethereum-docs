...
Learn how to operate all the basic functions of a wallet. If you don’t have one yet, check out our [How to create an Ethereum account](../how-to-create-an-ethereum-account/).
...
![Send field for crypto address](../../public/content/guides/how-to-use-a-wallet/send.png)\
...
![Button allowing user to connect to the website with a wallet](../../public/content/guides/how-to-use-a-wallet/connect1.png)
...
![Selecting from a list of wallets to connect with](../../public/content/guides/how-to-use-a-wallet/connect2.png)
